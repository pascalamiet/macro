...
\begin{center}
$y^~* = (\frac{s}{n+g_{se}+\delta+ng_{se}}\right)^{\frac{\alpha}{1-\alpha}}(1-s_{R})$ \\
$A_t = (\frac{\rho(s_{R}L_{t})^{\lambda}}{g_{se}})^(frac{1}{1-\phi})$\\
$L_t^(frac{\lambda}{1-\phi}) = L_0^{\frac{\lambda}{1-\phi}}(1+g_{se})^t$\\
$y_t^* = (\frac{s}{n+g_{se}+\delta+ng_{se}}\right)^{\frac{\alpha}{1-\alpha}}(1-s_{R})s_R^{\frac{\lambda}{1-\phi}}\left(\frac{\rho}{g_{se}} \right)^{\frac{1}{1-\phi}}L_0^{\frac{\lambda}{1-\phi}}(1+g_{se})^t $\\
\end{center}
